    ...
    <FooterSection>
      <div className="footerInner">
        <span>
          <h2>About</h2>
          <ul>
            <li>How Travel-info works</li>
            <li>Newsroom</li>
            <li>Travel-info 2021</li>
            <li>Investors</li>
            <li>Travel-info Plus</li>
            <li>Travel-info Luxe</li>
            <li className="lg-hidden">HotelTonight</li>
            <li className="lg-hidden">Travel-info for Work</li>
        ...
        <span>
          ...
          <ul>
            ...
            <li>Accessibility</li>
            <li>Travel-info Associates</li>
            <li>Frontline Stays</li>
            <li>Guest Referrals</li>
            <li>Travel-info.org</li>
          </ul>
        </span>
        <span>
          <h2>Host</h2>
